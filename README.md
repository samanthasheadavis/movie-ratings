# Movie Lens Online
#### Week 4 Weekend Homework

Teammates: Samantha (Front End), [Jason (Front End)](https://github.com/jasonhcarr), [Dan (Back End)](https://github.com/Logiconictvtube)

Move Lens Online was a group project between the front end and back end students. This project was a movie search and rating interface where the top twenty movies are displayed to the user, and the user can search and rate movies from the Movie Lens database. This project is incomplete.

To-Do:
* Front End - Jquery POST to database so users can rate movies
* Front End - Polish style and refactor
